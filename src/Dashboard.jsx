...
export default function Dashboard() {
  ...
  useEffect(() => {
    ...
    setSessionId(stored || "default_session");
  }, []);
    ...
    <div className="dashboard-container">
      ...
      <div className="page-body">
        ...
        <div className="welcome-banner">
          <h2>Good to have you back, <span className="accent-text">Candidate</span> 👋</h2>
        ...
        <div className="setup-section">
          ...
          <div className="glass-card">
            <div className="card-title">
              ...
              Job Details
              {formSubmitted && <span style={{marginLeft:"auto",fontSize:"12px",color:"#00d68f",fontWeight:600}}>✓ Saved</span>}
            </div>
            ...
            <div className="cta-text">
              ...
              <div className="cta-status">
                ...
                <span className="status-label">
                  {isReady ? "All set — you're ready to go!" : "Complete setup above to unlock"}
                </span>
              </div>
            </div>
